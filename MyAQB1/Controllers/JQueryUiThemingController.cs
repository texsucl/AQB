...
{
    public class JQueryUiThemingController : Controller
    {
        private string instanceId = "JQueryUiTheming";
        ...
        public JQueryUiThemingController(IQueryBuilderService aqbs, IHostingEnvironment env, IConfiguration config)
        {
            _aqbs = aqbs;
            _env = env;
            _config = config;
